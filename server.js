...
const MONGODB_URI = 'mongodb+srv://Maichak0624:93489871a@cluster0.4a0pgto.mongodb.net/?appName=Cluster0';

console.log('Attempting MongoDB connect to:', MONGODB_URI.replace(/mongodb\+srv:\/\/[^:]+:[^@]+@/, 'mongodb+srv://***:***@'));
console.log('Mongoose initial readyState=', mongoose.connection.readyState);
mongoose.connect(MONGODB_URI, { dbName: 'booklib', serverSelectionTimeoutMS: 5000 })
  .then(() => {
